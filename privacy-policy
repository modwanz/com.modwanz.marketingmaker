Privacy Policy
This Privacy Policy applies to the applications: Intro Maker, Outro Maker | Brand Maker, Graphic Design | Mockup Creator, T-shirt Design | Business Card Maker, Templates | VideoADKing: Video Modwanz Maker| Video Brochures: Brochure Maker, and Vidsi: Promo Video Maker, developed by Alagiya Jinal Niravkumar.
...
Among the types of Personal Data that this Application collects, by itself or through third parties, there are: Tracker; Usage Data; unique device identifiers for advertising (Google Advertiser ID or IDFA, for example); Universally unique identifier (UUID); crash data; device information.
...
The Data concerning the User is collected to allow the Owner to provide its Service, comply with its legal obligations, respond to enforcement requests, protect its rights and interests (or those of its Users or third parties), detect any malicious or fraudulent activity, as well as the following: Advertising, Analytics, Infrastructure monitoring, Platform services and hosting and Managing contacts and sending messages.
...
Google Analytics for Firebase
Google Analytics for Firebase or Firebase Analytics is an analytics service provided by Google LLC or by Google Ireland Limited, depending on the location this Application is accessed from.
In order to understand Google's use of Data, consult Google's partner policy.
...
Firebase Cloud Messaging
Firebase Cloud Messaging is a message sending service provided by Google LLC or by Google Ireland Limited, depending on the location this Application is accessed from. Firebase Cloud Messaging allows the Owner to send messages and notifications to Users across platforms such as Android, iOS, and the web. Messages can be sent to single devices, groups of devices, or specific topics or User segments.
...
We have collected the following categories of personal information about you: identifiers, internet information, geolocation data and inferred information.
